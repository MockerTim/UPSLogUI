 ...
 *
 */
public class DynamicXYPlotExampleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.dynamic_xy_plot_example, container, false);

        initDynamicPlot(rootView);

        return rootView;
    }

    private void initDynamicPlot(View view) {
